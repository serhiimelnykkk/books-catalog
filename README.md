...
* Personal Library: Add, remove books and see the list
* Filter Books: By name, year published, author, and genres
* Responsive Layout: Seamless experience for mobile and desktop
...
```bash
git clone https://github.com/serhiimelnykkk/books-catalog.git
cd books-catalog
npm i
npm run dev
```
